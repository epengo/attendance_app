...
<div class="col-md-6">
    <form action="" id="user-form">
        ...
        <div class="form-group">
            <label for="password2" class="control-label">New Password2</label>
            <input type="password" name="password2" id="password2" class="form-control form-control-sm rounded-0" value="">
        </div>
        <div class="form-group">
